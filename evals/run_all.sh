...
K="${1:-3}"
CASES="${CASES:-source1 source2 source3 flat1 query1 dedup1 inject1 setup1 visual1 crosslink1 tags1 synth1 rebuild1 capture1 data1 url1 export1 dash1 color1 status1 claudehist1 codexhist1}"
